  ...
  const customTheme: CustomFlowbiteTheme = {
    ...
    tab: {
      ...
      tablist: {
        ...
        styles: {
          "default": "flex-wrap border-b border-white-700 dark:border-white-700 bg-white",
          "underline": "flex-wrap -mb-px border-b border-gray-700 dark:border-gray-700",
          "pills": "flex-wrap font-medium text-sm text-gray-500 dark:text-gray-400 space-x-2 bg-gray-500",
